/*************************************************
 ...
 13 rounds.  This sktech generates random sequence, plays music, and displays button lights.

 This sketch was modified from a project by SparkFun Electronics
 ...
 This code was modified to support an ATTINY84A microcontroller for a Science, Technology, Engineering
 and Math (STEM) activity at Raytheon Company in Fullerton, CA.
...
void play_beegees()
{
  ...
  digitalWrite(BUZZPIN, LOW); // setup the "BUZZPIN" side of the buzzer to stay low, while we play the tone on the other pin.
